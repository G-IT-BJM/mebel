...
$as = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM tproduksi WHERE no_produksi = '$no_trans'"));

$no_pesanan = @$as['no_pesanan'];
$id_pesanan = @$as['id_detail_pesanan'];
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select readonly" id="no_pesanan" name="no_pesanan" required>
                                                    <option value="">Pilih No Pemesanan . . .</option>
                                                    <?php 
                                                        $sql = mysqli_query($conn, "SELECT no_pesanan, (SELECT nama_p FROM mpelanggan WHERE mpelanggan.id_pelanggan=tpemesanan.id_pelanggan) as nama_p from tpemesanan");
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select readonly" id="id_pesanan" name="id_pesanan" required>
                                                    <option value="">Pilih Pemesanan . . .</option>
                                                    <?php 
                                                        $sql = mysqli_query($conn, "SELECT * FROM tdetail_pemesanan WHERE id = '$id_pesanan'");
