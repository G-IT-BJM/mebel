                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="harga_beli" name="harga_beli" value="<?= $data["hbeli"] ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-2">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="total" name="total" value="<?= $data["total"] ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
