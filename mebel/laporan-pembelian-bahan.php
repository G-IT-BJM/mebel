                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-title">
                            <h4>LAPORAN PEMBELIAN BAHAN</h4>
                            <hr>
                        </div>
                        <form class="form-horizontal" action="cetak-laporan-pembelian-bahan.php" target="_BLANK" method="post" enctype="multipart/form-data">
                        <div class="header-title">
                            <div class="form-row">
                                <div class="col-sm-3">
