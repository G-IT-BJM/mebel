...
<?php
                        ...
                        IF (isset($_GET['id_tukang'])){
                            $select_kode= $_GET['id_tukang'];
                        }else{
                            echo "<div class='alert alert-info text-center'>Tidak Ada Data Yang Dipilih</div>";
                        }
                        
                        $query  ="SELECT * FROM mtukang where id_tukang = '$select_kode'";
                        ...
                        $query = "UPDATE mtukang SET nama='$nm', alamat='$al', telp='$tp' WHERE id_tukang='$select_kode'";
                        $sql   = mysql_query($query);
                            IF ($sql) {
 ...
 <div class="widget-header">
  ...
  <div class="widget-content">
   ...
   <form class="form-horizontal row-border" action="" method="post">
    ...
    <div class="col-md-10"><input type="text" name="idt" class="form-control" readonly="" placeholder="ID Tukang" value="<?php echo $id?>"></div> 
    </div> 
