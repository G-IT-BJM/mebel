 ...
 <div class="widget-header">
  ...
  <div class="widget-content">
   ...
   <form class="form-horizontal row-border" action="halaman.php?go=SimpanPesanan" method="post" name="proseshitung" id="proseshitung">
    ...
    </i> Silakan masukkan data Kerusakan pada Borang di bawah ini dengan benar ! </div> <div class="form-group"> <label class="col-md-2 control-label">Kode Kerusakan:</label> 

<?php
include 'koneksi.php';
$data = mysql_query("select * from trusak order by no_kerusakan DESC LIMIT 0,1");
$i= mysql_fetch_array($data) ;
$hari=date("Ymd");
$kodeawal=substr($i['no_kerusakan'],11,4)+1;
$trans='RS-';
...
?>
   ...
   <label class="col-md-4 control-label">Kode Produksi :</label> 
    ...
    <input class="form-control" type="text" id="biaya" name="tujuan"  placeholder="Input Kode Produksi" required=""  autocomplete="off">
     ...
     <div class="form-group"> 
    <label class="col-md-2 control-label">Total Kerusakan :</label> 
    <div class="col-md-2">
    <input class="form-control" type="text" name="jenishitung" required="" autocomplete="off">
    </div>
     <label class="col-md-5 control-label">Kerugian :</label> 
    <div class="col-md-2">
