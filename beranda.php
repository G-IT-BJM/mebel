                ...
                <div class="sales-report-area mt-5 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20">
                                    <?php $q = mysqli_fetch_array(mysqli_query($conn, "SELECT count(distinct no_pesanan) AS JUMLAH FROM tproduksi WHERE (no_pesanan) NOT IN (SELECT no_pesanan FROM tkirim GROUP BY tkirim.no_pesanan)")) ?>
                                    <div class="icon" style="background-color:#007BFF;"><?= $q['JUMLAH']?></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title"> </h4>
