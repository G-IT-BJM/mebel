        ...
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <?php 
                            $data = mysqli_fetch_array(mysqli_query($conn,"SELECT MAX(no_kerusakan) AS no_ FROM trusak"));
                            $no  = $data['no_'];
                        ...
                        <form id="rusakForm" enctype="multipart/form-data">
                            <h4 class="header-title">TAMBAH DATA KERUSAKAN</h4>
                            <hr>
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="no_pesan" class="col-form-label">Kode Kerusakan</label>
                                        <input class="form-control" type="text" id="no_kerusakan" name="no_kerusakan" value="<?= $no ?>" required readonly>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="tgl_rusak" class="col-form-label">Tanggal Rusak</label>
                                        <input class="form-control" type="text" id="tgl_rusak" name="tgl_rusak" value="<?=date('Y-m-d')?>" readonly>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                            ...
                            <div class="header-title">
                                ...
                                <button type="submit" <?= ($no_pesanan == '' || $no_produksi == '' || $jumlah_rusak == '' || $jenis_rusak == '') ? 'disabled' : '' ?> class="btn btn-success" id="simpan_kerusakan" name="simpan_kerusakan">SIMPAN <span class="fa fa-check-square-o"></span></button>
                            </div>                        
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#simpan_kerusakan").click(function() {
        ...
        if (jumlah > <?=$jumlah?>) {
            ...
            var datax = 'simpan_kerusakan=true&'+$("#rusakForm").serialize();
            // alert(datax);
            $.ajax({ 
                type: 'POST', 
