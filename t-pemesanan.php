                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" id="id_pelanggan" name="id_pelanggan" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control readonly" type="date" value="<?= date("Y-m-d"); ?>" id="tgl_beli" name="tgl_beli" required>
                                    </div>
                                </div>
                            </div>
                            </form>
