 ...
 <div class="widget-header">
  ...
  <div class="widget-content">
   ...
   <form class="form-horizontal row-border" action="halaman.php?go=SimpanBahan" method="post">
    ...
    </i> Silakan Ubah Sandi pada Borang di bawah ini dengan benar ! </div> <div class="form-group"> <label class="col-md-2 control-label">Kata Sandi:</label> 

    <div class="col-md-5"><input type="password" name="kdb" class="form-control" placeholder="Input Sandi Lama" ></div> 
    </div> 
    <div class="form-group"> 
    <label class="col-md-2 control-label">Kata Sandi Baru:</label> 
    <div class="col-md-5">
    <input class="form-control" type="password" name="nama1" placeholder="Input Kata Sandi Baru" required="" autocomplete="off"></div>
    </div>
     <div class="form-group"> 
    <label class="col-md-2 control-label">Konfirmasi:</label> 
    <div class="col-md-5">
    <input class="form-control" type="password" name="nama1" placeholder="Konfirmasi Kata Sandi Baru" required="" autocomplete="off"></div>
     </div>
     <?php
//      <div class="form-group">
...
//        </div> 
 ?>
        ...
        <button type="submit" class="btn btn-success" name="Simpan">Simpan Perubahan Data
        </button>
