 ...
 <div class="widget-header">
  ...
  <div class="widget-content">
   ...
   <form class="form-horizontal row-border" action="halaman.php?go=SimpanBahan" method="post">
    ...
    </i> INFORMASI SISTEM MEBEL </div> <div class="form-group"> <label class="col-md-2 control-label">Nama Aplikasi:</label> 

    <div class="col-md-5">
   <label class="col-md-10 control-label">Sistem Informasi Mebel CV.Sumber Bahagia</label> </div> 
    </div> 
    <div class="form-group"> 
    <label class="col-md-2 control-label">Proggramer:</label> 
    <div class="col-md-2">
    <label class="col-md-10 control-label">Ruspiati</label> 
    </div>
    </div>
    <div class="form-group"> 
    <label class="col-md-2 control-label">Tahun Pembuatan:</label> 
    <div class="col-md-2">
    <label class="col-md-10 control-label">2019</label> 
    </div>
    </div>
