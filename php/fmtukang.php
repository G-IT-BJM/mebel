...
?>
 ...
 <div class="widget-header">
  ...
  </i> Masukkan Data Tukang</h4> 
  </div> 
  <div class="widget-content">

   <form class="form-horizontal row-border" action="halaman.php?go=SimpanTukang" method="post">
    <div class="alert alert-info fade in"> 
    <i class="icon-remove close" data-dismiss="alert">
    </i> Silakan masukkan data Tukang pada Borang di bawah ini dengan benar ! </div> <div class="form-group"> <label class="col-md-2 control-label">ID Tukang:</label> 

<?php
include 'koneksi.php';
$data = mysql_query("select * from mtukang order by id_tukang DESC LIMIT 0,1");
$i= mysql_fetch_array($data) ;
$kodeawal=substr($i['id_tukang'],3,4)+1;
if($kodeawal<10){
  $kode='TK-000'.$kodeawal;
...
?>
    ...
    <div class="col-md-10"><input type="text" name="idt" class="form-control" readonly="" placeholder="ID Tukang" value="<?php echo $kode?>"></div> 
    </div> 
    <div class="form-group"> 
    <label class="col-md-2 control-label">Nama Lengkap:</label> 
    <div class="col-md-10">
    <input class="form-control" type="text" name="nama1" placeholder="Masukkan Nama Tukang" required="" autocomplete="off"></div>
     </div>
      <div class="form-group">
       <label class="col-md-2 control-label">Alamat Lengkap:</label> 
       <div class="col-md-10"><input class="form-control" type="text" name="alamat1" placeholder="Masukkan Alamat Tukang" autocomplete="off" required="">
       </div> 
       </div> 
       <div class="form-group">
