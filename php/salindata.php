 ...
 <div class="widget-header">
  ...
  <div class="widget-content">
   ...
   <form class="form-horizontal row-border" action="halaman.php?go=SimpanBahan" method="post">
    ...
    </i> Silakan Salin Data pada Borang di bawah ini !! </div> <div class="form-group"> 

    <label class="col-md-2 control-label">Database Sistem:</label> 

    <div class="col-md-5"><input type="text" value="db_mebel" name="kdb" readonly="readonly" class="form-control" placeholder="Input Sandi Lama" ></div> 
    </div> 
    
    
        
        
    <button type="submit" class="btn btn-primary" name="Simpan"><i class="icon-print"> Salin Database
        </button></i>
