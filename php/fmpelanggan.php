...
?>
 ...
 <div class="widget-header">
  ...
  </i> Masukkan Data Pelanggan</h4> 
  </div> 
  <div class="widget-content">

   <form class="form-horizontal row-border" action="halaman.php?go=SimpanPelanggan" method="post">
    <div class="alert alert-info fade in"> 
    <i class="icon-remove close" data-dismiss="alert">
    </i> Silakan masukkan data Pelanggan pada Borang di bawah ini dengan benar ! </div> <div class="form-group"> <label class="col-md-2 control-label">ID Pelanggan:</label> 

<?php
include 'koneksi.php';
$data = mysql_query("select * from mpelanggan order by id_pelanggan DESC LIMIT 0,1");
$i= mysql_fetch_array($data) ;
$kodeawal=substr($i['id_pelanggan'],3,4)+1;
if($kodeawal<10){
  $kode='PL-000'.$kodeawal;
...
?>
    ...
    <div class="col-md-10"><input type="text" name="idp" class="form-control" readonly="" placeholder="ID Pelanggan" value="<?php echo $kode?>"></div> 
    </div> 
    <div class="form-group"> 
    <label class="col-md-2 control-label">Nama Lengkap:</label> 
    <div class="col-md-10">
    <input class="form-control" type="text" name="nama1" placeholder="Masukkan Nama Pelanggan" required="" autocomplete="off"></div>
     </div>
      <div class="form-group">
       <label class="col-md-2 control-label">Alamat Lengkap:</label> 
       <div class="col-md-10"><input class="form-control" type="text" name="alamat1" placeholder="Masukkan Alamat Pelanggan" autocomplete="off" required="">
       </div> 
       </div> 
       <div class="form-group">
