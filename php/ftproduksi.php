 ...
 <div class="widget-header">
  ...
  <div class="widget-content">
   ...
   <form class="form-horizontal row-border" action="halaman.php?go=SimpanPesanan" method="post" name="proseshitung" id="proseshitung">
    ...
    </i> Silakan masukkan data Produksi pada Borang di bawah ini dengan benar ! </div> <div class="form-group"> <label class="col-md-2 control-label">Nomor Produksi:</label> 

<?php
include 'koneksi.php';
$data = mysql_query("select * from tproduksi order by no_produksi DESC LIMIT 0,1");
$i= mysql_fetch_array($data) ;
$hari=date("Ymd");
$kodeawal=substr($i['no_produksi'],11,4)+1;
$trans='PR-';
...
?>
    ...
    <div class="form-group"> 
     ...
     <?php 
                                              $querynm = "SELECT tpemesanan.no_pesanan, mpelanggan.nama_p, tpemesanan.biaya, tpemesanan.jpesanan, tpemesanan.namabarang, mpelanggan.id_pelanggan
                                              FROM tpemesanan
                                              ...
                                              while ($hasil = mysql_fetch_array($sqlnm)) {
                                                echo "<option value='".$hasil['no_pesanan']."'";
                                                if ($hasil['namabarang'] == @$bahan) {
                                                  echo " selected";
                                                } else{
                                                  echo "";
                                                }
   ...
   <label class="col-md-4 control-label">Biaya :</label> 
    <div class="col-md-2">
    <input class="form-control" type="number" id="biaya" name="biaya" readonly="readonly" placeholder="999.999.999" required=""  value="<?php echo $biaya; ?>"autocomplete="off">
    </div>
    </div>
     <div class="form-group"> 
    ...
    <div class="col-md-2">
    <input class="form-control" type="text" name="jenishitung" placeholder="Ex. 20x30 " readonly="readonly" required="" autocomplete="off">
    </div>
    </div>
    <div class="form-group"> 
    ...
    <div class="col-md-2">
    <input class="form-control" type="number" name="jumlah" readonly="readonly" onkeyup="hitung()" onkeydown="hitung()" onchange="hitung()" placeholder="Jumlah Pesan" required="" autocomplete="off">
    </div>
    </div>
     <div class="form-group"> 
    ...
    <label class="col-md-5 control-label">Keuntungan:</label> 
    <div class="col-md-2">
    <input class="form-control" type="number" name="jumlah" readonly="readonly" onkeyup="hitung()" onkeydown="hitung()" onchange="hitung()" placeholder="Keuntungan" required="" autocomplete="off">
    </div>
    </div>
